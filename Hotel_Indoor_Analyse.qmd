...
Der Random Forest Regressor zeigt eine deutliche Verbesserung gegenüber der linearen Regression, jedoch mit Einschränkungen. Mit einem **R²-Wert von 0.5378** kann das Modell etwa **53.78%** der Varianz der RSRP-Werte erklären. Der **Mean Squared Error (MSE)** liegt bei **40.14**, was auf eine moderate Genauigkeit des Modells hinweist. Während der Random Forest durch seine Fähigkeit, nicht-lineare Beziehungen besser abzubilden, eine bessere Leistung zeigt, ist die Vorhersagegenauigkeit noch nicht optimal.
